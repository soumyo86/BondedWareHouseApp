...
public class HTTPRequester {
	private static final Logger _LOGGER = Logger.getLogger(HTTPRequester.class.getName());
	 ...
	 */
	public static HTTPResponse sendPostRequest(String url, String postBody, Map<String, String> header) {
		...
		try {
			...
			response = new HTTPResponse(HTTPResponse.CLIENT_SIDE_ERROR, th.getMessage());
		}
		return response;
	}
